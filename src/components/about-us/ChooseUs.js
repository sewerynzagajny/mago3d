...
export default function ChooseUs({ className = "" }) {
  ...
  useEffect(() => {
    ...
    updateRootMargin();
    const debouncedUpdate = debounce(updateRootMargin, 100);
    window.addEventListener("resize", debouncedUpdate);
    return () => window.removeEventListener("resize", debouncedUpdate);
  }, []);
        ...
        >
          ...
          <div>
            <ScrollEffectContainer
              ...
              flag={() => {
                setFlag1(true);
                setTimeout(() => setPageVisited1(true), 2400);
              }}
            >
              <h3 className="heading-tertiary">Dlaczego warto nas wybrać?</h3>
            </ScrollEffectContainer>
            ...
            <ul
              className={`${className}__choose-us__list ${
                flag1 || pageVisited1 ? "is-visible" : "is-hidden"
              }`}
            >
              {chooseUsListItems.map((item, index) => (
                <ScrollEffectContainer
          ...
          <div>
            <ScrollEffectContainer
              ...
              flag={() => {
                setFlag2(true);
                setTimeout(() => setPageVisited2(true), 3000);
              }}
            >
              <h3 className="heading-tertiary">Czym się zajmujemy?</h3>
            </ScrollEffectContainer>
            ...
            <ul
              className={`${className}__choose-us__list ${
                flag2 || pageVisited2 ? "is-visible" : "is-hidden"
              }`}
            >
              {WeDoListItems.map((item, index) => (
                <ScrollEffectContainer
