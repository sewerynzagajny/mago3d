        ...
        <div className="grid-2-col">
          ...
          >
            <div className="1-col background">
              ...
              >
                Rozmawiamy o Twojej wizji, funkcji i wyglądzie produktu.
              ...
              <p className={`${className}__container__content u-font-strong`}>
                Wybieramy filament najlepiej dopasowany do zastosowania (PLA,
                PETG i inne) oraz ustawiamy parametry druku dla perfekcyjnego
                efektu.
              </p>
            </div>
          </ScrollEffectContainer>
          ...
          >
            <div className="2-col background">
              ...
              <p
                className={`${className}__container__content u-font-strong u-margin-bottom-medium`}
              >
                Każdy wydruk przechodzi dokładną weryfikację - sprawdzamy
