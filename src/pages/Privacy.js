...
export default function Privacy() {
  const seoData = {
    title: "Polityka prywatności - MaGo3d | Ochrona danych osobowych",
    description:
      "Zapoznaj się z polityką prywatności MaGo3d. Dowiedz się, jakie dane zbieramy, jak je przetwarzamy i jakie masz prawa zgodnie z RODO.",
    canonicalUrl: "https://mago3d.pl/polityka-prywatnosci",
        ...
        <div className="privacy__container">
          ...
          >
            ...
            <p className="u-margin-bottom-medium-large">
              ...
              <a href="https://mago3d.pl">https://mago3d.pl</a> i wyjaśnia
              zasady przetwarzania danych osobowych użytkowników oraz stosowania
              plików cookies.
            </p>
            ...
            <p className="u-margin-bottom-medium-large">
              Podstawą prawną przetwarzania jest Twoja zgoda (art. 6 ust. 1 lit.
              a RODO) oraz nasz uzasadniony interes (art. 6 ust. 1 lit. f RODO).
            </p>
            ...
            <p className="u-margin-bottom-medium-large">
              Dane przechowujemy przez okres prowadzenia korespondencji oraz do
              2 lat po jej zakończeniu w celach archiwalnych i dowodowych, chyba
              że wcześniej poprosisz o ich usunięcie.
            </p>
            ...
            <p>
              ...
              (np. dostawcy hostingu <strong>HostingHouse.pl</strong>),
            ...
            <p>
              ...
              działania strony oraz prowadzenia statystyk (np. liczba
              odwiedzin).
            </p>
            <p className="u-margin-bottom-medium-large">
