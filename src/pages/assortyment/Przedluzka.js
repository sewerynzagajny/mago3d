...
export default function Przedluzka({ productId = 15 }) {
  ...
  const items = [
    {
      type: "image",
      src: require("../../assets/assortment/Przedluzka/1.webp"),
      alt: imageAlt,
    },
  ];
          ...
          <div className="details__container">
            ...
            <div className="details__container__content ">
              ...
              <div className="details__container__content__text">
                <h4>
                  ⭐ Przedłużka długości 0,5m razem z łącznikami pasująca do
                  wszystkich naszych stojaków ⭐
                </h4>
                <p>
                  Prosta konstrukcja pozwalająca na wydłużenie wszystkich
                  naszych stojaków o 0,5m.
                </p>
                <h5>
                  <strong>Zestaw zawiera:</strong>
                </h5>
                <p>➡️ 2 szt. profilu aluminiowego długości 0,5m.</p>
                <p>➡️ 2 szt. łącznik.</p>
