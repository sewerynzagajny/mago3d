...
export default function USBConnect({ productId = 16 }) {
  ...
  const items = [
    {
      type: "image",
      src: require("../../assets/assortment/USBConnect/1.webp"),
      alt: imageAlt,
    },
  ];
  ...
  const seoData = {
    title: "Zestaw podłączeniowy USB do ekspozytorów LED Hot Wheels | MaGo3d",
    description:
      "Zestaw podłączeniowy USB do oświetlenia gablotek LED i kart Hot Wheels. Bezpieczne połączenie równoległe z dwóch stron. Sprawdź w MaGo3d!",
          ...
          <div className="details__container">
            ...
            <div className="details__container__content ">
              ...
              <div className="details__container__content__text">
                <h4>
                  ⭐ Zestaw podłączeniowy do ekspozytorów gablotek LED i
                  oświetlenia kart Hot Wheels. ⭐
                </h4>

                <h5>
                  <strong>Cechy produktu:</strong>
                </h5>
                <p>➡️ Zapewnia połączenie równoległe z dwóch stron.</p>
                <p>
                  ➡️ Element niezbędny do podłączenia oświetlenia gablotek i
                  oraz oświetlenia kart Hot Wheels.
                </p>
                <p>
                  ➡️ Podłączenie pod gniazdo USB jest najbardziej uniwersalnym
                  oraz najbezpieczniejszym podłączeniem diod LED nie powodując
                  ich nagrzewania oraz zapewniając długą żywotność.
                </p>
