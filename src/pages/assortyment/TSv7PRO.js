...
export default function TSv7PRO({ productId = 19 }) {
  ...
  const items = [
    {
      type: "image",
      src: require("../../assets/assortment/TSv7PRO/1.webp"),
      alt: imageAlt,
    },
    {
      type: "image",
      src: require("../../assets/assortment/TSv7PRO/2.webp"),
      alt: imageAlt,
    },
    {
      type: "image",
      src: require("../../assets/assortment/TSv7PRO/3.webp"),
      alt: imageAlt,
    },
    {
      type: "image",
      src: require("../../assets/assortment/TSv7PRO/4.webp"),
      alt: imageAlt,
    },
    {
      type: "image",
      src: require("../../assets/assortment/TSv7PRO/5.webp"),
      alt: imageAlt,
    },
  ];
  ...
  const seoData = {
    title: "Podstawka z kółkami pod Thermomix TM5 TM6 TSv7PRO | MaGo3d",
    description:
      "Podstawka z kółkami pod Thermomix TM5 TM6 TSv7PRO. Wzmocniona konstrukcja, idealne dopasowanie, możliwość przesuwania. Sprawdź w MaGo3d!",
          ...
          <div className="details__container">
            ...
            <div className="details__container__content ">
              ...
              <div className="details__container__content__text">
                <h4>
                  ⭐ Podstawka TSv7PRO z kółkami pod Vorwerk Thermomix® TM7
                  CZARNA ⭐
                </h4>
                ...
                <p>
                  ➡️ <strong>Wymiary:</strong> dł. 385mm x szer: 230mm x wys:
                  60mm (z podkładkami).
                </p>
                <p>
                  ➡️ <strong>Waga:</strong> 490g.
                </p>

                <h5>
                  <strong>
                    Najważniejsze zalety podstawki pod Thermomix TM7 :
                  </strong>
                </h5>
                <p>
                  ✅ <strong>Skrojona na miarę:</strong> Podstawka jest idealnie
                  dopasowana do urządzenia Thermomix TM7, nie wystaje poza obrys
                  jego kształtu (podczas robienia posiłków bardzo trudno
                  ubrudzić podstawkę), sam kształt podstawki odsłania również
                  wymiennik ciepła pod Thermomixem ułatwiając jego chłodzenie
                </p>
                <p>
                  ✅ <strong>Lekka i wytrzymała konstrukcja:</strong> Ok. 490
                ...
                <p>
                  ✅ Specjalnie okrągłe zagłębienia pod stopki Thermomix® TM7
                  zapewniają idealne dopasowanie.
                </p>
                ...
                <p>
                  ...
                  wytłumiają drgania, a 6 punktów podparcia zapewnia niesamowitą
                  stabilność.
                </p>
                <p>
                ...
                <p>
                  ⚠️Podstawka TSv7PRO jest zastrzeżonym wzorem wspólnotowym i
                ...
                <p>
                  <strong>
                    Pozdrawiamy serdecznie i zapraszamy do zakupów, oraz do
                    zapoznania się z naszą całą ofertą podstawek z kółkami pod
                    Verwerk Thermomix TM5,TM6 i TM7!!
                  </strong>
                </p>
