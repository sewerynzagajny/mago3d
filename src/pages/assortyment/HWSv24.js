...
export default function HWSv24({ productId = 5 }) {
  ...
  const seoData = {
    title: "Stojak na Hot Wheels HWSv24 naścienny | MaGo3d",
    description:
      "Stojak na Hot Wheels HWSv24 naścienny. Aluminiowe profile, mocowanie do biurka, pojemność 24 karty. Sprawdź w MaGo3d!",
